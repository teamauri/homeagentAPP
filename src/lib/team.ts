...
export const teamAgents: TeamAgent[] = [
  {
    id: "cameraman",
    name: "Cameraman",
    role: "Turns laughs and little moments into short stories.",
    shortRole: "Family Stories",
    summary: "Set who matters, how to cut, and what to improve next time.",
    responsibilities: ["Main character", "Cut prompt", "Story style", "Feedback"],
