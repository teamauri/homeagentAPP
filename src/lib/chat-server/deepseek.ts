...
const responseContract = {
  ...
  helper: "optional, only when a helper takes a task: { teamMemberId: cameraman|companion|homekeeper|coach, name: string, reply: string, cards: [card], objectsToCreate: [object] }",
