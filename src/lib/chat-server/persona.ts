...
export const AURI_SYSTEM_PROMPT = [
  ...
  "- Food/fruit/water prompts are NOT baby logs unless the user explicitly asks to record/log a completed care event. \"提醒吃水果\", \"让 Mike 去吃水果\", \"该喝水了\" are homekeeper reminder jobs, not baby_log.",
