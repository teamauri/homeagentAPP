  ...
  return (
    <div className="grid grid-cols-[44px_minmax(0,1fr)] gap-2.5">
      ...
      <div className="min-w-0">
        ...
        <p className={clsx("inline-block max-w-[98%] rounded-[16px] rounded-tl-[5px] px-3.5 py-2 text-[13px] leading-[19px] tracking-[0] text-ink", chatBubbleBg)}>
  ...
  return (
    <div className="grid grid-cols-[44px_minmax(0,1fr)] gap-2.5">
      ...
      <div className="min-w-0">
        ...
        <p className={clsx("mb-2 inline-block max-w-[98%] rounded-[16px] rounded-tl-[5px] px-3.5 py-2 text-[13px] leading-[19px] tracking-[0] text-ink", chatBubbleBg)}>
